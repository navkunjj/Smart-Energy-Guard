...
const WiringDiagram = ({ readings, theft, isOffline }) => {
  ...
  const Wire = ({ x1, y1, x2, y2, color, dashed, animated = true }) => (
    <line 
  ...
  // Reusable node box
  const NodeBox = ({ x, y, label, sublabel, value, isTheft, width = 90, height = 56 }) => {
    ...
    <div className="glass-card rounded-2xl p-4 lg:p-8 overflow-hidden relative">
      ...
      <div className="w-full overflow-x-auto scrollbar-none flex justify-center">
        <svg viewBox="0 0 800 520" className="w-full min-w-[700px] max-w-4xl" style={{ maxHeight: '70vh' }}>
          ...
          {/* Battery to VS */}
          <Wire x1={400} y1={460} x2={400} y2={420} color={mainWire} />
          {/* VS to CS4 */}
          <Wire x1={400} y1={420} x2={400} y2={350} color={mainWire} />
          {/* CS4 to Main Split */}
          <Wire x1={400} y1={350} x2={400} y2={300} color={mainWire} />

          {/* Main Split to Poles */}
          <Wire x1={400} y1={300} x2={210} y2={300} color={mainWire} /> {/* Left to Pole 1 */}
          <Wire x1={400} y1={300} x2={590} y2={300} color={mainWire} /> {/* Right to Pole 2 */}

          {/* Up to PCS Nodes */}
          <Wire x1={210} y1={300} x2={210} y2={220} color={mainWire} />
          <Wire x1={590} y1={300} x2={590} y2={220} color={mainWire} />

          {/* Pole 1 (PCS1) Split */}
          <Wire x1={210} y1={220} x2={210} y2={160} color={pole1Wire} />
          <Wire x1={210} y1={160} x2={110} y2={160} color={pole1Wire} /> {/* Left to H1 */}
          <Wire x1={210} y1={160} x2={310} y2={160} color={pole1Wire} /> {/* Right to H2 */}
          <Wire x1={110} y1={160} x2={110} y2={90} color={pole1Wire} /> {/* Up to H1 */}
          <Wire x1={310} y1={160} x2={310} y2={90} color={pole1Wire} /> {/* Up to H2 */}

          {/* Pole 1 Theft Wire (only drawn if theft) */}
          {theft?.pole1Theft && (
            <Wire x1={210} y1={160} x2={210} y2={90} color={theftColor} />
          )}

          {/* Pole 2 (PCS2) Split */}
          <Wire x1={590} y1={220} x2={590} y2={160} color={pole2Wire} />
          <Wire x1={590} y1={160} x2={530} y2={160} color={pole2Wire} /> {/* Left to H3 */}
          <Wire x1={530} y1={160} x2={530} y2={90} color={pole2Wire} /> {/* Up to H3 */}

          {/* Pole 2 Theft Wire (only drawn if theft) */}
          {theft?.pole2Theft && (
            <>
              <Wire x1={590} y1={160} x2={650} y2={160} color={theftColor} />
              <Wire x1={650} y1={160} x2={650} y2={90} color={theftColor} />
            </>
          )}

          {/* Auxiliary Components to VS */}
          <Wire x1={520} y1={420} x2={400} y2={420} color={normalColor} animated={false} /> {/* ESP32 to VS */}
          <Wire x1={660} y1={420} x2={600} y2={420} color={dimColor} dashed animated={false} /> {/* Firebase to ESP32 */}
          ...
          <NodeBox x={400} y={350} label="Main Input" value={CS4} isTheft={theft?.mainTheft} />
          <NodeBox x={210} y={220} label="Pole 1" value={PCS1} isTheft={theft?.pole1Theft} />
          <NodeBox x={590} y={220} label="Pole 2" value={PCS2} isTheft={theft?.pole2Theft} />


          {/* ── End Nodes (Houses & Theft Loads) ────────────────────── */}
          
          {/* Pole 1 - Houses */}
          <NodeBox x={110} y={90} label="House 1" value={CS1} isTheft={theft?.pole1Theft} />
          <NodeBox x={310} y={90} label="House 2" value={CS2} isTheft={theft?.pole1Theft} />
          ...
          {/* Pole 2 - House */}
          <NodeBox x={530} y={90} label="House 3" value={CS3} isTheft={theft?.pole2Theft} />
